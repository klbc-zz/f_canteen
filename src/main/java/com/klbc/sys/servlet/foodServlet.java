...
import com.klbc.sys.service.FoodService;
import com.klbc.sys.service.FoodServiceImpl;
import com.klbc.sys.service.FoodTypeService;
import com.klbc.sys.service.FoodTypeServiceImpl;
...
//				
				...
				//String filePath = getServletContext().getRealPath("upload/food");
				String filePath = "E:\\code\\java\\jsp\\f_canteen\\f_canteen\\src\\main\\webapp\\upload\\food";
				System.out.println("filepath:"+filePath);
