...
<%@ page language="java" import="com.klbc.app.pojo.Food" %>
<!DOCTYPE html>
...
<div id="banner">
        ...
        <c:if test="${ empty session_user }">
            <li class="bannerli">
                <a onclick="window.location.href='${pageContext.request.contextPath}/app/register.do?method=toPage';">注册</a>
            </li>
            <li class="bannerli">
...
<!--            1-->
            <c:if test="${not empty foods}">
            	<c:forEach items="${foods}" var="food" varStatus="index">
            		<div class="img">
            			 <div class="imgkuang">
               			 	<img src="${pageContext.request.contextPath}/upload/food/${food.img}"  alt="picture" width="300" height="200">
               			 </div>
               			 <div class="imgma">
                 		 	<div>
...
<div class="footer">
    <a href="${pageContext.request.contextPath}/sys/loginsys.do">管理中心</a>
</div>
